...
public class Piece {
    ...
    public void pawnPromotion(int endRow) {
        System.out.println("choose to promote your pawn to: Rook, Knight, Bishop or Queen.");
        Scanner scanner = new Scanner(System.in);
        String input = scanner.nextLine();

        if ((character == '\u2659' || character == '\u265f') && (input.equals("Rook") || input.equals("Queen") || input.equals("Bishop") || input.equals("Knight"))) {
            if (endRow == 7) {
        ...
        while ((character == '\u2659' || character == '\u265f') && !(input.equals("Rook") || input.equals("Queen") || input.equals("Bishop") || input.equals("Knight"))) {
            System.out.println("choose to promote your pawn to: Rook, Knight, Bishop or Queen.");
            input = scanner.nextLine();
            if (endRow == 0) {
                if (input.equals("Rook")) {
                    System.out.println("fdfsfdsa");
                    character = '\u265c';
                } else if (input.equals("Knight")) {
                    character = '\u265e';
                } else if (input.equals("Bishop")) {
